...
if __name__ == '__main__':
    data_path = "datasets_sub/oracle_lines.json"
    box_path = "datasets_sub/oracle_boxs.json"
    data_dir = "/workspace/tapin_diffusion/contornet/datasets/tapian"
    ...
    # 保存数据集
    with open("datasets_sub/train_dataset.json", "w", encoding = "utf-8") as f:
        json.dump(new_train_dataset, f, ensure_ascii = False, indent = 4)

    with open("datasets_sub/test_dataset.json", "w", encoding = "utf-8") as f:
        json.dump(new_test_dataset, f, ensure_ascii = False, indent = 4)
    
    with open("datasets_sub/all_dataset.json", "w", encoding = "utf-8") as f:
